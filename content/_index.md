...
This is my personal brain dump. Unfortunately, it doesn't help free up much room, but it's an attempt! It is built with [Hugo](https://gohugo.io/) and uses the [Relearn](https://mcshelby.github.io/hugo-theme-relearn/index.html) Theme. The list of [topics](#contents) will change over time.
